...
describe('EPPage', () => {
  ...
  it('renders the EP name for a non-lovesickage EP', () => {
    const { container } = render(<EPPage theme={thehill} onArtworkClick={() => {}} />)
  ...
  it('renders HeartbeatTitle for lovesickage EP', () => {
    const { container } = render(<EPPage theme={lovesickage} onArtworkClick={() => {}} />)
  ...
  it('calls onArtworkClick when artwork is clicked', () => {
    ...
    const { container } = render(<EPPage theme={thehill} onArtworkClick={handleClick} />)
  ...
  it('shows Pre-Save and Follow buttons for coming statusType', () => {
    const { getByText } = render(<EPPage theme={lovesickage} onArtworkClick={() => {}} />)
