...
describe('StoryProgress', () => {
  it('renders a progress bar for each EP', () => {
    const { container } = render(
      <StoryProgress eps={EP_THEMES} currentEP={0} storyProgress={0} />,
    )
  ...
  it('fills completed EPs to 100%', () => {
    const { container } = render(
      <StoryProgress eps={EP_THEMES} currentEP={1} storyProgress={50} />,
    )
  ...
  it('fills current EP to storyProgress percentage', () => {
    const { container } = render(
      <StoryProgress eps={EP_THEMES} currentEP={0} storyProgress={42} />,
    )
    const fills = container.querySelectorAll('.progress-fill')
  ...
  it('leaves future EPs at 0%', () => {
    const { container } = render(
      <StoryProgress eps={EP_THEMES} currentEP={0} storyProgress={50} />,
    )
    const fills = container.querySelectorAll('.progress-fill')
  ...
  it('handles edge case where storyProgress is 100', () => {
    const { container } = render(
      <StoryProgress eps={EP_THEMES} currentEP={0} storyProgress={100} />,
    )
    const fills = container.querySelectorAll('.progress-fill')
    expect((fills[0] as HTMLElement).style.width).toBe('100%')
  })
