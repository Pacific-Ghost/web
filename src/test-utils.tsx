...
import { ServicesContext, type ServicesContainer } from './services/ServicesProvider'
import type { IAudioPlayer } from './services/AudioPlayer/AudioPlayerService'

export function mockAudioPlayer(overrides: Partial<IAudioPlayer> = {}): IAudioPlayer {
  return {
    play: vi.fn(),
    pause: vi.fn(),
    toggle: vi.fn(),
